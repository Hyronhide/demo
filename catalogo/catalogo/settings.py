...
ALLOWED_HOSTS = ['catalagodavid.heroKuapp.com']
...
SECRET_KEY = 'fvc%ag7ku1zl)ca+9gr(!)hgnn*_^$kpu2&wlcz-s%^=07wj)2'
...
EMAIL_PORT = '25'
EMAIL_HOST_USER = 'david-b60@hotmail.com'
EMAIL_HOST_PASSWORD = 'b6032d255223rxw1'
EMAIL_USE_TLS = True
